...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-24 relative overflow-hidden bg-gray-900 border-t border-gray-800">
        ...
        >
          {projects.map((project, index) => (
            <motion.div
              ...
              className="bg-gray-800/40 hover:bg-gray-800/80 transition-colors duration-300 rounded-xl p-8 border border-gray-700/50 flex flex-col h-full group"
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href={project.live} className="text-gray-400 hover:text-white hover:scale-110 transition-all">
              ...
              <ul className="flex flex-wrap gap-3 mt-auto">
                {project.tech.map((item, i) => (
                  <li key={i} className="text-cyan-300/80 text-sm font-mono bg-cyan-500/10 px-3 py-1 rounded-full">
                    {item}
                  </li>
                ))}
              </ul>
